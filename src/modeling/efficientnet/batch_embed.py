# src/modeling/efficientnet/batch_embed.py
import torch
import numpy as np
import pandas as pd
...
from model import EfficientNetEmbedding
...
ARTIFACT_DIR = "artifacts/efficientnet"
...
def run():
    ...
    print("EfficientNet embeddings generated:", embeddings.shape)
